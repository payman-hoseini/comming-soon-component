  ...
  return (
    <>
      <div className="max-w-3xl w-[80vw] mx-auto grid place-items-center mt-12">
        ...
        <div className="mt-10 font-Franklin text-center">
          <h1 className="md:text-[55px] text-xl text-costum-Gray tracking-wide">We are launching <span className="text-black font-bold">soon!</span></h1>
          <p className="mt-2 font-light md:text-lg text-sm text-Very-Dark-Blue">Subscribe and get notified</p>
        </div>
        <Input />
        <div className="flex justify-center mt-14">
          <Image src={dashboard} alt="Dashboard" className="w-[90%]"/>
        </div>
