...
import dashboard from "@/style/img/illustration-dashboard.png"
...
export default function Home() {
  return (
    <>
      <div className="max-w-3xl w-[80vw] mx-auto grid place-items-center mt-12">
        ...
        <div className="md:mt-14 mt-10 font-Franklin text-center">
          <h1 className="md:text-[55px] text-2xl text-costum-Gray tracking-wide">We are launching <span className="text-Very-Dark-Blue font-bold">soon!</span></h1>
          <p className="md:mt-8 mt-4 font-light md:text-2xl text-sm text-Very-Dark-Blue">Subscribe and get notified</p>
        </div>
        <Input />
        <div className="flex justify-center mt-14">
          <Image src={dashboard} alt="Dashboard" className="md:w-[90%]"/>
        </div>
        <div className="mt-10 flex space-x-3">
          <Socials />
        </div>
        <div className="mt-3">
          <p className="text-[10px] text-costum-Gray font-Franklin">&copy; Copyright Ping. All rights reserved.</p>
        </div>
      </div>
    </>
  );
